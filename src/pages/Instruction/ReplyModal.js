...
import { resetMessage } from 'store/Instruction/actions'

const ReplyModal = ({ modal, toggle, data, setLoadingSpinner, t }) => {
    ...
    useEffect(() => {
        if (numTemp) dispatch(getCheckDownloadData({ file_num: numTemp }))
    }, [numTemp])
