...
const EditRole = props => {
  ...
  useEffect(() => {
    if (selectedMaintainRole?.status === "1") {
      ...
      editRoleFormik.setFieldValue(
        "roleName",
        selectedMaintainRole.data.result?.roleName
      )
      editRoleFormik.setFieldValue(
        "roleId",
        selectedMaintainRole.data.result?.roleId
      )
      editRoleFormik.setFieldValue(
        "roleParentName",
  ...
  const appCallBackRole = row => {
    ...
    editRoleFormik.setFieldValue("parentRoleId", row.roleId)
                ...
                <div className="d-flex flex-row col-10 align-items-center py-2 justify-content-between">
                  ...
                  <div className="col-8" style={{ marginTop: "-8px" }}>
                    <Input
                      type="text"
                      disabled
                      value={editRoleFormik.values.roleId}
                      invalid={
                        editRoleFormik.touched.roleId &&
                ...
                <div className="d-flex flex-row col-10 align-items-center py-2 justify-content-between">
                  ...
                  <div className="col-8" style={{ marginTop: "-8px" }}>
                    <Input
                      ...
                      invalid={
                        editRoleFormik.touched.roleParentName &&
                        editRoleFormik.errors.roleParentName
                          ? true
                          : false
                      }
                      onChange={e =>
                ...
                <div className="d-flex flex-row col-10 align-items-center py-2 justify-content-between">
                  ...
                  <div className="col-8" style={{ marginTop: "-8px" }}>
                    <Input
                      ...
                      invalid={
                        editRoleFormik.touched.roleName &&
                        editRoleFormik.errors.roleName
                          ? true
                          : false
                      }
                      onChange={e =>
                        editRoleFormik.setFieldValue("roleName", e.target.value)
                      }
                    />
                    <FormFeedback type="invalid">
                      {editRoleFormik.errors.roleName}
