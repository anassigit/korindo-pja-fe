...
import {
  ...
  getOwner,
  saveInstructions,
} from "../../store/appInstructions/actions"
...
const AddInstructions = props => {
  ...
  const [addInstructionsStartDate, setAddInstructionsStartDate] = useState(
    format(currentDate, "yyyy-MM-dd"),
    ""
  )
  const [addInstructionsFirstRenderDone, setAddInstructionsFirstRenderDone] =
    useState(false)
  ...
  const addInstructionsValidInput = useFormik({
    ...
    onSubmit: val => {
      ...
      bodyForm.append(
        "insDate",
        format(addInstructionsValidInput.values.insDate, "yyyy-MM-dd")
      )
                    ...
                    <Col md="6">
                      <div className="mb-3 col-sm-10">
                        ...
                        <Input
                          ...
                          invalid={
                            addInstructionsValidInput.touched.title &&
                            addInstructionsValidInput.errors.title
                              ? true
                              : false
                          }
                        />
                      ...
                      <div className="mb-3 col-sm-10">
                        ...
                        <DatePicker
                          ...
                          onChange={date => {
                            ...
                            addInstructionsValidInput.handleChange(
                              "insDate",
                              date
                            )
                            addInstructionsValidInput.setFieldTouched(
                              "insDate",
                              true
                            )
                          }}
                          selected={
                            addInstructionsValidInput.values.insDate
                              ? new Date(
                                  addInstructionsValidInput.values.insDate
                                )
                              : null
                          ...
                          isClearable={false}
                          invalid={
                            addInstructionsValidInput.touched.insDate &&
                      ...
                      >
                        ...
                        <Input
                          ...
                          value={"Not Started"}
                          invalid={
                            addInstructionsValidInput.touched.status &&
                            addInstructionsValidInput.errors.status
                              ? true
                              : false
                          }
                        >
                    ...
                    <Col md="6">
                      <div className="mb-3 col-sm-8">
                        ...
                        <Select
                          ...
                          className={`select2-selection ${
                            addInstructionsValidInput.errors.owner &&
                            addInstructionsValidInput.touched.owner
                              ? "custom-invalid"
                              : ""
                          }`}
                          styles={colourStyles}
                      ...
                      <div className="mb-3 col-sm-8">
                        ...
                        <Select
                          ...
                          className={`select2-selection ${
                            addInstructionsValidInput.errors.manager &&
                            addInstructionsValidInput.touched.manager
                              ? "custom-invalid"
                              : ""
                          }`}
