...
const EditInstructions = props => {
  ...
  const [editInstructionsFirstRenderDone, setEditInstructionsFirstRenderDone] =
    useState(false)
  let memberId = ReactSession.get("user")
    ? JSON.parse(ReactSession.get("user")).id
    : ""
  let pId = ReactSession.get("user")
    ? JSON.parse(ReactSession.get("user")).pname
    : ""
  ...
  useEffect(() => {
    ...
    editInstructionsValidInput.setFieldValue(
      "title",
  ...
  const editInstructionsValidInput = useFormik({
    ...
    onSubmit: values => {
      ...
      if (getDetailInstructionData?.data?.instruction?.comment === false) {
        ...
        bodyForm.append(
          "insDate",
          format(editInstructionsValidInput.values.insDate, "yyyy-MM-dd")
        )
    ...
    if (getSelectedFiles.length > 0) {
      for (let index = 0; index < getSelectedFiles.length; index++) {
        setGetFiles(preValue => {
          return [...preValue, getSelectedFiles[index]]
        })
        break
      }
      setGetSelectedFiles([])
                          ...
                          <Col md="6">
                            ...
                            <div className="mb-3 col-sm-10">
                              ...
                              <Input
                                ...
                                value={
                                  editInstructionsValidInput.values.title || ""
                                }
                            ...
                            <div className="mb-3 col-sm-10">
                              ...
                              <Col>
                                <Input
                                  ...
                                  value={
                                    editInstructionsValidInput.values
                                      .description || ""
                                  }
                                  invalid={
