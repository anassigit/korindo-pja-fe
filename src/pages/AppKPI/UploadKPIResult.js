...
import { resetMessage, uploadKPI, uploadKPIResult } from 'store/appKPI/actions'

const UploadKPIResult = (props) => {
    ...
    const insertUpload = async (value) => {
        await dispatch(uploadKPIResult(value))
    }
...
export default withTranslation()(UploadKPIResult)